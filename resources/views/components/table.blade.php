            ...
            <tbody>
                ...
                @forelse ($blogList as $item)
                    <tr
                        ...
                        <td class="px-6 py-4 font-semibold text-gray-900 dark:text-white">
                            {{ \Illuminate\Support\Str::substr($item->description, 0, 50) }}
                        </td>
                        <td class="px-6 py-4">
                            <a wire:navigate href="/blog/{{ $item->id }}"
                                    ...
                                    <div class="relative bg-stone-100 rounded-lg shadow dark:bg-gray-700">
                                        ...
                                        <div class="p-4 md:p-5 text-center">
                                            ...
                                            <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Are
                                                you sure you want to delete {{$item->title}}?</h3>
                                            <button wire:click="delete({{$item}})" data-modal-hide="{{$item->id}}" type="button"
